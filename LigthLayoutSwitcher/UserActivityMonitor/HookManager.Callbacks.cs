        ...
        private static int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0)
            {
                ...
                if (s_KeyDown != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
                {
                    ...
                    bool shiftPressed = (GetKeyState((int) (Keys.ShiftKey)) & 0x80) == 0x80;
                    bool altPressed = (GetKeyState((int)(Keys.Menu)) & 0x80) == 0x80;
                    bool contrlolPressed = (GetKeyState((int) (Keys.ControlKey)) & 0x80) == 0x80;
                    
                    keyData |= shiftPressed ? Keys.Shift : 0;
                ...
                {
                    Keys keyData = (Keys)MyKeyboardHookStruct.VirtualKeyCode;
                    keyData |= GetKeyState((int)(Keys.ControlKey) & 0x80) == 0x80 ? Keys.Control : 0;
                    keyData |= GetKeyState((int)(Keys.Menu) & 0x80) == 0x80 ? Keys.Alt : 0;
                    keyData |= GetKeyState((int)(Keys.ShiftKey) & 0x80) == 0x00 ? Keys.Shift : 0;
                    KeyEventArgs e = new KeyEventArgs(keyData);
